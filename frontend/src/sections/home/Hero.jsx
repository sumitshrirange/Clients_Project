...
const Hero = ({ profile }) => {
  ...
  const shouldEnable3D = () => {
    ...
    return !prefersReducedMotion && !isNarrow && !isLowEnd && !saveData;
  };
  ...
  const tagline =
    profile?.tagline ||
    "Designing intuitive experiences that solve real problems.";
  const chips = profile?.expertiseChips?.length
    ? profile.expertiseChips
    : EXPERTISE;
  ...
  return (
    ...
    >
      ...
      <FloatingDoodle
        className="top-24 left-4 lg:left-10 text-primary/40 dark:text-primary-light/40"
        rotate={-8}
        delay={0.2}
        mobileVisible
      >
      ...
      <FloatingDoodle
        className="top-1/2 right-4 lg:right-10 text-mint"
        rotate={10}
        delay={0.6}
        duration={5}
      >
      ...
      <FloatingDoodle
        className="bottom-16 left-8 lg:left-16 text-primary/30 dark:text-primary-light/30"
        rotate={4}
        delay={0.9}
        duration={8}
      >
      ...
      <FloatingDoodle
        className="top-44 left-1/3 text-blue/40"
        rotate={0}
        delay={0.4}
        duration={6}
      >
      ...
      <FloatingDoodle
        className="bottom-40 right-1/4 text-primary/30 dark:text-primary-light/30"
        rotate={-14}
        delay={1.1}
        duration={7}
      >
      ...
      <FloatingDoodle
        className="top-1/3 left-1/4 text-cream"
        rotate={20}
        delay={0.7}
        duration={6}
      >
      ...
      <FloatingDoodle
        className="bottom-10 right-1/3 text-mint/80"
        rotate={0}
        delay={1.3}
        duration={5}
      >
      ...
      <FloatingDoodle
        className="top-1/4 right-1/3 text-primary/30 dark:text-primary-light/30"
        rotate={-6}
        delay={0.5}
        duration={7}
      >
      ...
      <FloatingDoodle
        className="bottom-1/4 left-1/2 text-blue/30"
        rotate={8}
        delay={0.8}
        duration={6}
      >
      ...
      <div className="relative max-w-6xl mx-auto px-6 sm:px-8 grid lg:grid-cols-[1.1fr_0.9fr] gap-16 items-center">
        <div>
          ...
          >
            {name}
            <span
              className="absolute -bottom-2 left-0 w-full h-3 bg-gradient-to-r from-primary/25 via-blue/25 to-mint/25 dark:from-primary/30 dark:via-blue/30 dark:to-mint/30 -z-10 rounded-full blur-[2px]"
              aria-hidden="true"
            />
          </motion.h1>
        ...
        >
          ...
          {show3D && (
            <div className="absolute -inset-10 z-0 pointer-events-none will-change-transform">
          ...
          <FloatingCard
            className="-left-8 top-6 flex items-center gap-2 z-20"
            rotate={-6}
            delay={0.3}
          >
            <Figma className="w-4 h-4 text-primary" />
            <span className="text-xs font-semibold text-ink-soft dark:text-canvas/70 pr-1">
              Figma
            </span>
          </FloatingCard>

          <FloatingCard
            className="-right-6 top-1/3 block w-32 z-20"
            rotate={5}
            delay={0.5}
          >
          ...
          <FloatingCard
            className="-left-4 bottom-10 flex items-center gap-2 z-20 bg-cream dark:bg-surface-dark"
            rotate={-3}
            delay={0.7}
          >
            <StickyNote className="w-4 h-4 text-ink-soft dark:text-canvas/70" />
            <span className="text-xs font-medium text-ink-soft dark:text-canvas/70">
              User-first
            </span>
          </FloatingCard>

          <FloatingCard
            className="right-4 -bottom-6 flex items-center justify-center w-11 h-11 z-20"
            rotate={0}
            delay={0.9}
          >
          ...
          <FloatingCard
            className="-right-9 bottom-16 flex items-center justify-center w-11 h-11 z-20"
            rotate={-8}
            delay={1.1}
          >
          ...
          <FloatingCard
            className="-left-10 top-1/2 flex items-center justify-center w-10 h-10 z-20"
            rotate={9}
            delay={1.3}
          >
      ...
      >
        <ArrowDown
          className="w-5 h-5 text-ink-faint dark:text-canvas/40 animate-bounce"
          aria-hidden="true"
        />
      </motion.div>
    </section>
